...
public class LifeStyleUtils {
    private static final String TAG = LifeStyleUtils.class.getSimpleName();
    private static final String LOG_TAG = LifeStyleUtils.class.getSimpleName();
    ...
    public static String StringUrlBuilder() {
        ...
        builder.scheme("https")
                ...
                .appendQueryParameter("q", "lifestyle")
    ...
    public static List<NewsFeed> extractFeatureFromJson(String jsonResponse) {
        ...
        try {
            ...
            Log.e("LifeStyleUtils", "Problem parsing the NewsFeed JSON results", e);
        }
        return newsFeeds;
    }
}